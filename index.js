...
const instagram = 'blom buat'; 
const telegram = 'blom buat'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'Blom ada yt';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@khuzaifi09.id')
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@khuzaifi09.id`)
})
